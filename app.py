...
if prompt := st.chat_input("พิมพ์โจทย์ หรือสั่งให้ AI วิเคราะห์..."):
    ...
    with st.chat_message("assistant"):
        try:
            ...
            instr = "อธิบายละเอียดใจดีและแสดงวิธีทำเป็นขั้นเป็นตอน (Step-by-step)" if "อธิบายละเอียด" in response_style else "เฉลยอย่างกระชับ"
            sys_prompt = f"""คุณคืออาจารย์คณิตศาสตร์ระดับมหาวิทยาลัย ({instr}) 
            ...
            2. รูปแบบสมการ: บังคับใช้ LaTeX ในการเขียนสมการ 100% ห้ามใช้อักขระพิเศษสำเร็จรูป
               ...
               - สมการในบรรทัดให้ครอบด้วย $...$
               - สมการแยกบรรทัดให้ครอบด้วย $$...$$ และจัดให้อยู่กึ่งกลาง
            3. การจัดหน้าตา: แบ่งเป็นหัวข้อชัดเจน เช่น **ขั้นที่ 1: กำหนดตัวแปร**, **ขั้นที่ 2: แทนค่า**, **คำตอบสุดท้าย:**
            4. ตอบเฉพาะสิ่งที่ผู้ใช้ถาม ห้ามทำข้ออื่นเด็ดขาด
